...
TEXTS: dict[str, dict[str, str]] = {
    ...
    "uz_latin": {
        ...
        "phone_required": "⚠️ Telefon raqamini kiritish majburiy! Iltimos, telefon raqamingizni yuboring.",
        "phone_invalid": "⚠️ Noto'g'ri telefon raqam formati!\n\nIltimos, to'g'ri telefon raqam kiriting.\nMasalan: +998901234567 yoki 901234567",
        "ask_fullname": "👤 Iltimos, familiya, ism va otangizning ismini to'liq yozing.\n\nMasalan: <b>Aliyev Vali Akmalovich</b>",
        "fullname_required": "⚠️ F.I.Sh ni kiritish majburiy! Iltimos, to'liq familiya, ism va otangizning ismini yozing.",
        "ask_address": "🏠 Yashash manzilingizni to'liq yozing.\n\nMasalan: <b>Navoiy vil, Navoiy shahar, Bunyodkor MFY, Lochin ko'chasi, 10-uy</b>",
        "address_required": "⚠️ Manzilni kiritish majburiy! Iltimos, yashash manzilingizni to'liq yozing.",
    ...
    "uz_cyrillic": {
        ...
        "phone_required": "⚠️ Телефон рақамини киритиш мажбурий! Илтимос, телефон рақамингизни юборинг.",
        "phone_invalid": "⚠️ Нотўғри телефон рақам формати!\n\nИлтимос, тўғри телефон рақам киритинг.\nМасалан: +998901234567 ёки 901234567",
        "ask_fullname": "👤 Илтимос, фамилия, исм ва отангизнинг исмини тўлиқ ёзинг.\n\nМасалан: <b>Алиев Вали Акмалович</b>",
        "fullname_required": "⚠️ Ф.И.Ш ни киритиш мажбурий! Илтимос, тўлиқ фамилия, исм ва отангизнинг исмини ёзинг.",
        "ask_address": "🏠 Яшаш манзилингизни тўлиқ ёзинг.\n\nМасалан: <b>Навоий вил, Навоий шаҳар, Бунёдкор МФЙ, Лочин кўчаси, 10-уй</b>",
        "address_required": "⚠️ Манзилни киритиш мажбурий! Илтимос, яшаш манзилингизни тўлиқ ёзинг.",
    ...
    "ru": {
        ...
        "phone_required": "⚠️ Необходимо указать номер телефона! Пожалуйста, отправьте ваш номер телефона.",
        "phone_invalid": "⚠️ Неверный формат номера телефона!\n\nПожалуйста, введите корректный номер телефона.\nНапример: +998901234567 или 901234567",
        "ask_fullname": "👤 Пожалуйста, напишите свою фамилию, имя и отчество полностью.\n\nНапример: <b>Алиев Вали Акмалович</b>",
        "fullname_required": "⚠️ Необходимо указать Ф.И.О! Пожалуйста, напишите полностью фамилию, имя и отчество.",
        "ask_address": "🏠 Напишите ваш адрес проживания полностью.\n\nНапример: <b>Навоийская обл., г. Навои, МСГ Бунёдкор, ул. Лочин, дом 10</b>",
        "address_required": "⚠️ Необходимо указать адрес! Пожалуйста, напишите ваш адрес проживания полностью.",
